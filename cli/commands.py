...
from api.routes.predictions import _closing_line_snapshot, _value_bet_snapshot
...
class CLICommands:
    ...
    async def _warmup_brain_with_real_data(self, prophet: FootballProphet, league_code: str) -> None:
        ...
        await prophet.train_models_from_history([league_code])
    ...
    async def show_value_bets(self) -> None:
        ...
        try:
            ...
            for value_bet in value_preds:
                ...
                closing_odds, _, clv = _closing_line_snapshot(value_bet, odds)
                ...
                value_bets.append({
                    ...
                    "edge": value_bet.edge or 0,
                    "ev": value_bet.ev or 0,
                    "kelly_stake": value_bet.kelly_stake or 0,
                    "closing_odds": closing_odds or 0,
                    "clv": clv or 0,
                })
